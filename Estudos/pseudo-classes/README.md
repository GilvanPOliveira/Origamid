...
Exercícios sobre **pseudo-classes no CSS**, para criar estados e selecionar elementos por condição.

## 🧠 O que foi estudado

- `:hover`, `:focus`, `:active`
- `:first-child`, `:last-child`, `:nth-child()`
- Estados de formulário (`:checked`, `:disabled`, etc.)
- Seletores condicionais para UI mais rica
